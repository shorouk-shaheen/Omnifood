        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1"> 
                <div class="col span-1-of-4 box">
                     <i class="ion-md-infinite icon-big"></i>
                    <h3>Up to 365 days/year</h3>
                    <p>Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style.</p>
                </div>
                 <div class="col span-1-of-4 box">
                    <i class="ion-md-stopwatch icon-big"></i>
                    <h3>Ready in 20 minutes</h3>
                    <p>You're only twenty minutes away from your delicious and super healthy meals delivered right to your home. We work with the best chefs in each town to ensure that you're 100% happy.</p>
                </div>
                 <div class="col span-1-of-4 box">
                      <i class="ion-md-nutrition icon-big"></i>
                    <h3>100% organic</h3>
        ...
        <section class="section-steps" id="works">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2 steps-box">
                    ...
                    <a href="#" class="btn-app"><img src="resources/img/download-app.svg" alt="App Store Botton"/></a><a href="#" class="btn-app"><img src="resources/img/download-app-android.png" alt="Android Store Botton"/></a>
                </div>
            </div>
        </section>
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    ...
                    <div class="city-feature">
                        <i class="ion-md-person icon-small"></i>
                        1600+ happy eaters
                    </div>
                     <div class="city-feature">
                        <i class="ion-md-star icon-small"></i>
                        60+ top chefs
                    </div>
                     <div class="city-feature">
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-md-checkmark icon-small"></i>1 meal every day</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Order 24/7</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Access to newest creations</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
                 ...
                 <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-md-checkmark icon-small"></i>1 meal 10 days/month</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Order 24/7</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Access to newest creations</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Free delivery</li>
                            </ul>
                 ...
                 <div class="col span-1-of-3">
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                <li><i class="ion-md-checkmark icon-small"></i>1 meal every day</li>
                                <li><i class="ion-md-checkmark icon-small"></i>Order from 8 am to 12 pm</li>
                                <li><i class="ion-md-close icon-small"></i></li>
                                <li><i class="ion-md-checkmark icon-small"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
